  ...
  services.factory("authenticationSvc", ["Http", "$q", "$sessionStorage", "$state", function (Http, $q, $sessionStorage, $state) {
    return {
      ...
      forgot: function (data) {
        ...
        Http.getData('assets/data/forgotPassword.json', data).then(function (result) {
          deferred.resolve(result);
        }).catch(function (err) {
        });
        return deferred.promise;
      ...
      logout: function () {
        if (typeof $sessionStorage["userInfo"] != "undefined" && typeof $sessionStorage["userInfo"].email != "undefined") {
      ...
      getUserInfo: function () {
        return (typeof $sessionStorage["userInfo"] != "undefined" && typeof $sessionStorage["userInfo"].email != "undefined") ? $sessionStorage["userInfo"] : false;
      }
    };
  }]);
  return services;
